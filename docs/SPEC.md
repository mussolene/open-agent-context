...
Reference implementation v0.3.1 includes `memory_calls` as a backend-independent
...
v0.3.1 includes operation envelopes for `MemoryOperation`, `ContextOperation`,
...
Reference implementation v0.3.1 включает `memory_calls` как backend-independent
...
v0.3.1 включает operation envelopes для `MemoryOperation`, `ContextOperation`,
