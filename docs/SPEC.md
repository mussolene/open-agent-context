...
Reference implementation v0.3.2 includes `memory_calls` as a backend-independent
...
v0.3.2 includes operation envelopes for `MemoryOperation`, `ContextOperation`,
...
Reference implementation v0.3.2 включает `memory_calls` как backend-independent
...
v0.3.2 включает operation envelopes для `MemoryOperation`, `ContextOperation`,
